  ...
  <CardBody>
    ...
    <ListGroup>         
                    {/* <Link className="list-group-item list-group-item-action" tag="a" to="/Certificate" action>
                         ...
                         <Link className="list-group-item list-group-item-action" tag="a" to="/Placement/View" action>
                            View 
                        </Link> 
                     

                        <Link className="list-group-item list-group-item-action" tag="a" to="/Placement/Add" action>
                            Add 
                        </Link> 
