...
>
  ...
  <CardBody>
    ...
    <ListGroup>         
                    {/* <Link className="list-group-item list-group-item-action" tag="a" to="/Certificate" action>
                            Home
                        </Link>  */}
                 
                         <Link className="list-group-item list-group-item-action" tag="a" to="/Certificate/View" action>
                            View 
                        </Link> 
                     

                        <Link className="list-group-item list-group-item-action" tag="a" to="/Certificate/Add" action>
                            Add 
                        </Link> 
